        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 md:gap-6">
             <Link href="/panel" className="flex-shrink-0 transition hover:opacity-80">
                <div className="relative w-28 md:w-40 h-8 md:h-10">
                  <Image
             ...
             {/* Dikey Çizgi ve Firma Adı (Mobilde Gizli) */}
          ...
          <div className="flex items-center gap-2 md:gap-6">
             {/* QR Butonu (SADECE MASAÜSTÜ - Kesin Gizleme) */}
             <div className="hidden md:block">
               ...
               >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                      <path fillRule="evenodd" d="M3 4a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H4a1 1 0 01-1-1V4zm8-1a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H4a1 1 0 01-1-1V4zm-9 7a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H4a1 1 0 01-1-1v-4zm8-1a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H4a1 1 0 01-1-1v-4z" clipRule="evenodd" />
                  </svg>
                  <span>QR Kodlar</span>
               </Link>
             </div>
             ...
             <div className="flex flex-col items-end text-right">
                <span className="text-gray-800 font-bold text-xs md:text-base leading-tight max-w-[120px] truncate md:max-w-none block">
                    {session.user.name}
                </span>
                <Link 
                    href="/api/auth/signout" 
                    className="text-red-600 hover:text-red-800 hover:underline text-xs md:text-sm font-medium mt-0.5 block"
                >
                    Çıkış
                </Link>
             </div>
